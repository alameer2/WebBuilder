...
export class SimpleMemoryStorage implements IStorage {
  ...
  constructor() {
    ...
    // Add more sample series
    this.data.movies.push({
      id: "series-1",
      title: "Game of Thrones",
      originalTitle: "Game of Thrones",
      description: "مسلسل خيالي ملحمي يحكي قصة الممالك السبع والصراع على العرش الحديدي",
      year: 2011,
      duration: 57,
      rating: 9.3,
      imdbRating: 9.3,
    ...
    this.data.movies.push({
      ...
      description: "مسلسل كوميدي أمريكي يتابع حياة ستة أصدقاء في مدينة نيويورك",
      year: 1994,
      duration: 22,
      rating: 8.9,
      imdbRating: 8.9,
    ...
    this.data.movies.push({
      ...
      description: "مسلسل كوميدي أمريكي يتابع حياة موظفي شركة ورق في بنسلفانيا",
      year: 2005,
      duration: 22,
      rating: 8.7,
      imdbRating: 8.7,
